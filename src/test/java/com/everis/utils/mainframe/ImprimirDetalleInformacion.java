...
public class ImprimirDetalleInformacion {
    ...
    public static void datosValidos(List<WebElement> punto, ArrayList<String> informacion) throws IOException {
        ...
        FileWriter f1 =new FileWriter("C:/Users/x12090/Documents/TXT/ReporteUsuariosValidos.txt");
        ...
        Path credentialsFile = Paths.get("C:/Users/x12090/Documents/TXT/ReporteUsuariosValidos.txt");
        Serenity.recordReportData().withTitle("Evidencia Nexbi").fromFile(credentialsFile);
    }

    public static void datosInválidos(List<Map<String, String>> punto, ArrayList<String> informacion) throws IOException {
        ...
        //CREACION DE REPORTE.TXT
        FileWriter f1 =new FileWriter("C:/Users/x12090/Documents/TXT/ReporteUsuariosInvalidos.txt");
        PrintWriter out =new PrintWriter(f1);
        ...
        Path credentialsFile = Paths.get("C:/Users/x12090/Documents/TXT/ReporteUsuariosInvalidos.txt");
        Serenity.recordReportData().withTitle("Evidencia Nexbi").fromFile(credentialsFile);
    }
    ...
    public static void datosGenerales(List<WebElement> punto, ArrayList<String> informacion) throws IOException {
        ...
        for(int i=0;i<punto.size();i++){
            if(cantUsuarioActivoArrays[i]==0) {
                informacion.add   (" - Punto de Servicio Nro " + (i + 1) + ":   " + "000.00");
                System.out.println(" - Punto de Servicio Nro " + (i + 1) + ":   " + "000.00");
            }else{
        ...
        for(int i=0;i<incoherenciasCuentaMonto.size();i++){
            if (incoherenciasCuentaMonto.get(i).equals(coherenciaCuentaMonto[i])){
    ...
    public static void datosGeneralesSinUser(List<Map<String, String>> punto, ArrayList<String> informacion) throws IOException {
    ...
    public static void prueba(ArrayList<String> informacion) throws IOException {
        ...
        String[] montoCobrarArrays = Serenity.sessionVariableCalled("montoCobrarArrays");
        String[] coherenciaCuentaMonto = Serenity.sessionVariableCalled("coherenciaCuentaMonto");
        String[] incoherenciasCuentaMonto = Serenity.sessionVariableCalled("incoherenciasCuentaMonto");
        ...
        informacion.add   ("-------------------------" + "\n");
        System.out.println("-------------------------" + "\n");
        boolean incoherenciasEncontradas=true;
        for (int i = 0; i < montoCobrarArrays.length; i++) {
            if(!incoherenciasCuentaMonto[i].equals("No se encontro Incoherencia")) {
                incoherenciasEncontradas=false;
                informacion.add(" - incoherencia Punto de Servicio Nro " + (i + 1) + ":   " + incoherenciasCuentaMonto[i]);
                System.out.println(" - incoherencia Punto de Servicio Nro " + (i + 1) + ":   " + incoherenciasCuentaMonto[i]);
            }
        }
        if(incoherenciasEncontradas) {
