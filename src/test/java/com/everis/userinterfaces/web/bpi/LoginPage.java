...
public class LoginPage {
    ...
    public static final Target MENU_ENTENDIDO = Target.the("Entendido").located(By.xpath("(//*[contains(text(), 'Entendido')]/..)[2]"));
    ...
    public static final Target INP_CHOOSE_TYPE_ACCOUNT = Target.the("Seleccion de cuenta").located(By.xpath("//div[contains(text(), 'Corriente Soles    100-7001095125')]"));

    public static final Target INP_TYPE_COMPANY = Target.the("Empresa").located(By.xpath("//input[@data-test='txtServiceCompany']"));

    //public static final Target INP_CHOOSE_ELEG_EMPRE_SERVI = Target.the("Eleccion de servicio").located(By.xpath("(//span[text()='DONACIONES - SOLES '])"));
    ...
    public static final Target INP_CHOOSE_ELEG_EMPRE_SERVI2 = Target.the("Eleccion de Servicio 2").located(By.xpath("(//span[@class='mat-option-text'])[2]"));
    ...
    public static final Target CHECKBOX_TOTAL_MONTO_SERVICIOS = Target.the("Checkbox Total").located(By.xpath("//*[@id='mat-checkbox-4']"));
    public static final Target CHECKBOX_UNICO_MONTO_SERVICIOS = Target.the("Checkbox Unico").located(By.xpath("//*[@id='mat-checkbox-5']"));
    public static final Target INP_DESCRIPCION = Target.the("Descripción").located(By.xpath("//input[@data-test='txtDescription']"));
    public static final Target INP_MONTO = Target.the("Monto de Servicio").located(By.xpath("//input[@id='mat-input-10']"));
    ...
    public static final Target SALDO_DISPONIBLE_INICIAL = Target.the("Saldo Disponible").located(By.xpath("//button[@data-test='btnPayAgain']"));


    //  FUNCIONALIDAD DE VALIDAR SALDOS Y MOVIMIENTOS
    ...
    public static final Target TIPO_CUENTA = Target.the("Tipo de cuenta").located(By.xpath("//*[@data-test='lblAccountType']"));

    public static final Target NUMERO_CUENTA = Target.the("Numero de cuenta").located(By.xpath("//*[@data-test='lblAccountNumber']"));

    public static final Target SALDO_DISPONIBLE_CUENTA = Target.the("Saldo disponible de la cuenta").located(By.xpath("//*[@data-test='lblAvailableBalanceAmount']"));
    ...
    public static final Target CMB_SELECCIONAR_CUENTA = Target.the("Seleccionar Cuenta").located(By.xpath("//div[contains(text(), 'Corriente Soles    100-7001095125')]"));

    public static final Target BTN_BUSCAR_MOVIMIENTOS = Target.the("Buscar Movimientos").located(By.xpath("//*[@id='btnSearch']"));

    public static final Target LBL_DESCRIPCION = Target.the("Descripcion").located(By.xpath("(//*[@class='ibk-table-row ng-star-inserted'][1]//div)[5]"));

    public static final Target LBL_IMPORTE = Target.the("Importe").located(By.xpath("(//*[@class='ibk-table-row ng-star-inserted'][1]//span)[2]"));

    public static final Target LBL_SALDO_CONTABLE = Target.the("Saldo Contable").located(By.xpath("(//*[@class='ibk-table-row ng-star-inserted'][1]//span)[4]"));
    ...
    ///
//    public static final Target MOVIMIENTOS_FECHA_OPERACION= Target.the("Perfil especialista").located(By.cssSelector(".title"));
//    public static final Target MOVIMIENTOS_FECHA_PROCESO= Target.the("Perfil especialista").located(By.cssSelector(".title"));
//    public static final Target MOVIMIENTOS_MOVIMIENTOS= Target.the("Perfil especialista").located(By.cssSelector(".title"));
//    public static final Target MOVIMIENTOS_DESCRIPCION= Target.the("Perfil especialista").located(By.cssSelector(".title"));
//    public static final Target MOVIMIENTOS_CANAL= Target.the("Perfil especialista").located(By.cssSelector(".title"));
//    public static final Target MOVIMIENTOS_IMPORTE= Target.the("Perfil especialista").located(By.cssSelector(".title"));
    ...
    public static final Target DETALLE_DATOS_DEUDA_CUOTAS = Target.the("Datos de Deuda - Detalle").located(By.xpath("(//ibk-table-cell[@class='text-start  ibk-table-cell']/span)"));
    public static final Target DETALLE_VENCIMIENTO_CUOTAS = Target.the("Vencimiento- Detalle").located(By.xpath("(//ibk-table-cell[@class='ibk-table-cell c-black']/span)"));
    public static final Target DETALLE_CODIGO_CUOTAS = Target.the("Codigo de Cuota- Detalle").located(By.xpath("(//ibk-table-cell[@class='text-center ibk-table-cell']/span)[1]"));
    public static final Target DETALLE_MONTO_CUOTAS = Target.the("Monto de Cuotas- Detalle").located(By.xpath("(//ibk-table-cell[@class='text-right ibk-table-cell'])[1]"));
    public static final Target DETALLE_DSCT_MORA_CUOTAS = Target.the("Dcto (-) Mora(+) - Detalle").located(By.xpath("(//ibk-table-cell[@class='text-right ibk-table-cell'])[2]"));
    ...
    public static final Target DETALLE_MOTIVO_CUOTAS = Target.the("Motivos Cuotas- Detalle").located(By.xpath("(//*[@class='ibk-table-cell ng-star-inserted']/div)[2]"));
    ...
    public static final Target MODO_PAGO = Target.the("Modo de Pago").located(By.xpath("(//div[@class='mat-select-value']/span)[4]"));
