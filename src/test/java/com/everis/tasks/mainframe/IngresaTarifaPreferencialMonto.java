...
public class IngresaTarifaPreferencialMonto implements Task {
    ...
    public IngresaTarifaPreferencialMonto(String numeroConcepto, String codigoUnico, String fechaInicio, String fechaFin, String referencia, String autorizador, String monto) {
    ...
    public static Performable withData(String numeroConcepto, String codigoUnico, String fechaInicio, String fechaFin, String referencia, String autorizador, String monto) {
        return instrumented(IngresaTarifaPreferencialMonto.class, numeroConcepto, codigoUnico, fechaInicio, fechaFin, referencia, autorizador, monto);
    }
