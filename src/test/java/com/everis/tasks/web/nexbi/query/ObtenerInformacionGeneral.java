...
public class ObtenerInformacionGeneral implements Task {
    ...
    public ObtenerInformacionGeneral(int j, ArrayList<String> nombrePuntoServicioArrays, ArrayList<String> tipoClienteArrays, ArrayList<String> nivelServicioArrays, ArrayList<String> cuentaCargoArrays, ArrayList<String> monedaCuentaArrays) {
        this.j = j;
    ...
    public static Performable withData(int j, ArrayList<String> nombrePuntoServicioArrays, ArrayList<String> tipoClienteArrays, ArrayList<String> nivelServicioArrays, ArrayList<String> cuentaCargoArrays, ArrayList<String> monedaCuentaArrays) {
        return instrumented(ObtenerInformacionGeneral.class, j, nombrePuntoServicioArrays, tipoClienteArrays, nivelServicioArrays, cuentaCargoArrays, monedaCuentaArrays);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        do {
            ...
            monedaCuentaArrays.add(NexbiQuestions.monedaCuenta().answeredBy(theActorInTheSpotlight()).trim());
            cont++;
        ...
        tipoClienteArrays.add(NexbiQuestions.tipoCliente().answeredBy(theActorInTheSpotlight()).trim());

        /*Obtenemos el Nivel de Servicio desde el Intranet */
        nivelServicioArrays.add(NexbiQuestions.nivelServicio().answeredBy(theActorInTheSpotlight()).trim());

        /*Obtenemos la Cuenta de Cargo desde el Intranet */
        cuentaCargoArrays.add(NexbiQuestions.cuentaCargo().answeredBy(theActorInTheSpotlight()).trim());
