...
public class ObtenerInformacionGeneralSinUsuarios implements Task {
    ...
    public ObtenerInformacionGeneralSinUsuarios(int i, String[] tipoClienteArrays, String[] nivelServicioArrays, String[] cuentaCargoArrays, String[] monedaCuentaArrays) {
        this.i = i;
    ...
    public static Performable withData(int i, String[] tipoClienteArrays, String[] nivelServicioArrays, String[] cuentaCargoArrays, String[] monedaCuentaArrays) {
        return instrumented(ObtenerInformacionGeneralSinUsuarios.class, i, tipoClienteArrays, nivelServicioArrays, cuentaCargoArrays, monedaCuentaArrays);
    }
