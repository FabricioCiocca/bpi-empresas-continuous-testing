...
public class ObtenerDetalleUsuario implements Task {
    ...
    public ObtenerDetalleUsuario(int i, String[] tipoAccesoArrays, int[] cantUsuarioActivoArrays, int[] cantUsuarioArrays) {
        this.i = i;
    ...
    public static Performable withData(int i, String[] tipoAccesoArrays, int[] cantUsuarioActivoArrays, int[] cantUsuarioArrays){
        return instrumented(ObtenerDetalleUsuario.class,i,tipoAccesoArrays,cantUsuarioActivoArrays,cantUsuarioArrays);
    }
