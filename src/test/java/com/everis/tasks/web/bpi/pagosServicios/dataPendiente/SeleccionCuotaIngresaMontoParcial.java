...
public class SeleccionCuotaIngresaMontoParcial implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        for (int i = 1; dniPagadorArray.length >= i; i++) {
            ...
            Serenity.getDriver().findElement(By.xpath("(//ibk-card[" + i + "]//ibk-table-cell[7]/div/ibk-select/mat-form-field/div/div/div/mat-select/div/div[2]/div)[1]")).click();
