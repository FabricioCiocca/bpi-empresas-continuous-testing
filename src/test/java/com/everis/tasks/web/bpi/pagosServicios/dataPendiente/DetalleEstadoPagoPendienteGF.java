...
public class DetalleEstadoPagoPendienteGF implements Task {
    ...
    public DetalleEstadoPagoPendienteGF(String dniUsuario, String tipoCuenta, String cuentaOrigen) {
    ...
    public static Performable withData(String dniUsuario, String cuentaOrigen, String tipoCuenta) {
        ...
        return instrumented(DetalleEstadoPagoPendienteGF.class, dniUsuario, cuentaOrigen, tipoCuenta);
