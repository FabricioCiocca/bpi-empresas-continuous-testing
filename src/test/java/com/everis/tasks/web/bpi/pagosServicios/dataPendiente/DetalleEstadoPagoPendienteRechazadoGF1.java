...
public class DetalleEstadoPagoPendienteRechazadoGF1 implements Task {
    private final String Usuario;
    private final String tipoCuenta;
    private final String cuentaOrigen;

    public DetalleEstadoPagoPendienteRechazadoGF1(String Usuario, String tipoCuenta, String cuentaOrigen) {
    ...
    public static Performable withData(String dniUsuario, String cuentaOrigen, String tipoCuenta) {
        ...
        return instrumented(DetalleEstadoPagoPendienteRechazadoGF1.class, dniUsuario, cuentaOrigen, tipoCuenta);
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        if (fechaHoraAux.length == 6) {

            theActorInTheSpotlight().should(seeThat(
                    EstadoPagoQuestions.AutorizadorSolicitudDetalle(), containsString(nombreUsuarioAux[1].trim() + " - " + fechaHoraAux[2].trim())));

            theActorInTheSpotlight().should(seeThat(
                    EstadoPagoQuestions.AutorizadorSolicitudDetalle2(), containsString(nombreUsuarioAux[2].trim() + " - " + fechaHoraAux[4].trim())));
            ...
            theActorInTheSpotlight().should(seeThat(
                    EstadoPagoQuestions.AutorizadorSolicitudDetalle3(), containsString(nombreUsuarioAux[3].trim() + " - " + fechaHoraAux[6].trim())));

            System.out.println("usuario1: " + nombreUsuarioAux[1].trim() + " - " + fechaHoraAux[2].trim());
            System.out.println("usuario1: " + nombreUsuarioAux[2].trim() + " - " + fechaHoraAux[4].trim());
            System.out.println("usuario1: " + nombreUsuarioAux[3].trim() + " - " + fechaHoraAux[6].trim());
