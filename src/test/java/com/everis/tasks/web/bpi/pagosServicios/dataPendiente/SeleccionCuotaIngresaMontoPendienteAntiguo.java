...
public class SeleccionCuotaIngresaMontoPendienteAntiguo implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        for (int i = 1; dniPagadorArray.length >= i; i++) {
            ...
            if (LoginStepDefinitions.pagosServiciosData.getTipoDePago().equalsIgnoreCase("Parcial")) {
                ...
                if (tipoCuenta[1].equals("Soles") && LoginStepDefinitions.pagosServiciosData.getSimbolo().equals("$")) {
                    LoginStepDefinitions.pagosServiciosData.setmontoPagadoTipoCambio(String.valueOf(String.format("%.2f", Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getMontoIncial()) * Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getTipoDeCambioVenta()))));
                    LoginStepDefinitions.pagosServiciosData.setmontoTipoCambio(String.valueOf(String.format("%.2f", Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getmontoPagadoTipoCambio()) * Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getCantdni()))));//eeee
                } else if (tipoCuenta[1].equals("Dólares") && LoginStepDefinitions.pagosServiciosData.getSimbolo().equals("S/")) {
                    LoginStepDefinitions.pagosServiciosData.setmontoPagadoTipoCambio(String.valueOf(String.format("%.2f", Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getMontoIncial()) / Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getTipoDeCambioCompra()))));
                    LoginStepDefinitions.pagosServiciosData.setmontoTipoCambio(String.valueOf(String.format("%.2f", Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getmontoPagadoTipoCambio()) * Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getCantdni()))));
                }
                //------------------------------------------------------------------------------------------------------

                //MONTOS PAGADOS

                LoginStepDefinitions.pagosServiciosData.setmontosPagados(String.valueOf(String.format("%.2f", Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getMontoIncial()))));

                //MONTO TOTAL

                LoginStepDefinitions.pagosServiciosData.setMonto(String.valueOf(String.format("%.2f", Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getmontosPagados()) * Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getCantdni()))));//hice cambio
            ...
            } else if (LoginStepDefinitions.pagosServiciosData.getTipoDePago().equalsIgnoreCase("Total")) {
                ...
                LoginStepDefinitions.pagosServiciosData.setMontoIncial(LoginStepDefinitions.pagosServiciosData.getmontosPagados().replace(LoginStepDefinitions.pagosServiciosData.getSimbolo() + " ", "").replace(",", ""));
                ...
                if (tipoCuenta[1].equals("Soles") && LoginStepDefinitions.pagosServiciosData.getSimbolo().equals("$")) {
                    ...
                    LoginStepDefinitions.pagosServiciosData.setmontoTipoCambio(String.valueOf(String.format("%.2f", Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getmontoTipoCambio()) + Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getmontoPagadoTipoCambio()))));//eeee
                ...
                //MONTO TOTAL --> 10000.00
                LoginStepDefinitions.pagosServiciosData.setMonto(String.valueOf(String.format("%.2f", Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getMonto()) + Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getmontosPagados()))));
                ...
                LoginStepDefinitions.pagosServiciosData.setMonto(String.valueOf(String.format("%.2f", Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getmontosPagados()) * Double.parseDouble(LoginStepDefinitions.pagosServiciosData.getCantdni()))));
