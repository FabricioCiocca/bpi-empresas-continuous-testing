...
public class SCIMPNegatividadParcial implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitUntil.the(PagoRealizadoPage.BTN_CONINUE, isVisible()).forNoMoreThan(150).seconds(), Click.on(PagoRealizadoPage.BTN_CONINUE));
