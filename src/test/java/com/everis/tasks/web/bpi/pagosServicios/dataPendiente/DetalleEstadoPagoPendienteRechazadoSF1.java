...
public class DetalleEstadoPagoPendienteRechazadoSF1 implements Task {
    private final String dniUsuario;
    private final String tipoCuenta;
    private final String cuentaOrigen;

    public DetalleEstadoPagoPendienteRechazadoSF1(String dniUsuario, String tipoCuenta, String cuentaOrigen) {
    ...
    public static Performable withData(String dniUsuario, String cuentaOrigen, String tipoCuenta) {
        ...
        return instrumented(DetalleEstadoPagoPendienteRechazadoSF1.class, dniUsuario, cuentaOrigen, tipoCuenta);
