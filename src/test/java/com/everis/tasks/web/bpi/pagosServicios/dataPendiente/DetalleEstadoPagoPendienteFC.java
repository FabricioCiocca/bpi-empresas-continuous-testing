...
public class DetalleEstadoPagoPendienteFC implements Task {
    private final String dniUsuario;
    private final String tipoCuenta;
    private final String cuentaOrigen;

    public DetalleEstadoPagoPendienteFC(String dniUsuario, String tipoCuenta, String cuentaOrigen) {
    ...
    public static Performable withData(String dniUsuario, String cuentaOrigen, String tipoCuenta) {
        ...
        return instrumented(DetalleEstadoPagoPendienteFC.class, dniUsuario, cuentaOrigen, tipoCuenta);
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        assertEquals(
                LoginStepDefinitions.pagosServiciosData.getEstado(), "Pendiente");
