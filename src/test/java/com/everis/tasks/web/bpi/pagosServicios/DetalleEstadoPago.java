...
public class DetalleEstadoPago implements Task {
    private final String dniUsuario;
    private final String tipoCuenta;
    private final String cuentaOrigen;

    public DetalleEstadoPago(String dniUsuario, String tipoCuenta, String cuentaOrigen) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        theActorInTheSpotlight().should(seeThat(EstadoPagoQuestions.EstadoServicioDetalleProcesada(), equalTo(LoginStepDefinitions.pagosServiciosData.getEstadoSolicitudDetalle())));
        ...
        theActorInTheSpotlight().should(seeThat(EstadoPagoQuestions.PagoProcesadasDetalle(), equalTo(LoginStepDefinitions.pagosServiciosData.getCuotasPagar())));
        theActorInTheSpotlight().should(seeThat(EstadoPagoQuestions.PagoRechazadasDetalle(), equalTo("0")));
        ...
        theActorInTheSpotlight().should(seeThat(EstadoPagoQuestions.DetalleEstadoCuotas(), equalTo("Procesado")));
    ...
    public static Performable withData(String dniUsuario, String cuentaOrigen, String tipoCuenta) {
        return instrumented(DetalleEstadoPago.class, dniUsuario, cuentaOrigen, tipoCuenta);
    }
